I will sequentially, in separate messages, send you the task context, source data and the task itself. You should start solving only after I tell you “DO IT”. If you find a lack of information, you can explicitly request it from me before issuing a response. Confirm that you understand these instructions.
